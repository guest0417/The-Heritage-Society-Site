...
new Valine({
  ...
  avatar: 'retro',
  // requiredFields: ['nick'],
  emojiCDN: "<%= theme.cdn.url %>/emotion/",
  emojiMaps: {
    "alu_高兴": "alu/01.png",
    "alu_黑线": "alu/02.png",
    "alu_鼓掌": "alu/03.png",
...
function updateStyle() {
  ...
  if (getCookie("style") == "white") {
    $(".search_bar").attr("style", "color: #000000; background-color:white");
    $("#footer").attr("style", "color: #000000;");
    $(".flink").attr("style", "color: #000000;");
    $(".ba").attr("style", "color: #000000;");
    $("#bodyx").removeClass("bg_black");
    $("#update_style").attr('checked', false);
  } else {
    $(".search_bar").attr("style", "color: white;");
    $("#footer").attr("style", "");
    $(".flink").attr("style", "");
    $(".ba").attr("style", "");
